/*********************************************
Библиотека ШИМ/fx для Mega162, максимум - 6 фиксированных каналов
...
void InitFxPWM(void)
// Инициализация ШИМа
// Включение таймера 1. Теперь работают таймеры 1 и 3
{
  CNUM = 0;
  ...
  // Timer(s)/Counter(s) Interrupt(s) initialization (TIMSK=0x48)
  TIMSK=0x48;
  ETIMSK=0x04;
